...
class PadmaUpdaterAPI {
	...
	public function updater(){
		...
		$args = array(
	        ...
	        'remote_url'  => PADMA_CDN_URL,     // Set to the domain that should receive update requests.
	        'version'     => '0.0.1',					  // Adjust to your latest plugin version.	        
	    );
	...
	private function hook() {
		...
		add_filter( 'padma_updater_products', array( $this, 'add_theme_license_input' ) );
